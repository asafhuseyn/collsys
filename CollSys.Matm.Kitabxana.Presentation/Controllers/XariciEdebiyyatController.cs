...
{
    [Authorize]
    public class XariciEdebiyyatController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnvironment;

        public XariciEdebiyyatController(IWebHostEnvironment webHostEnvironment)
        {
            ...
            )
        {
            ...
            var exhibits = exhibitService.Read(c => c.Format == Format.XariciEdebiyyat);
            if (exhibits == null)
            {
                return View();
            }
                ...
                )
            {
                ...
                var accurateResults = exhibits.Where
                    (
                        c => (c.Format == Format.XariciEdebiyyat)
        ...
        public ActionResult Search(ExhibitModel exhibit)
        {
            ...
            var accurateResults = exhibitService.Read(c => (c.Format == Format.XariciEdebiyyat)
            ...
            {
                var generalResults = exhibitService.Read(c => (c.Format == Format.XariciEdebiyyat)
                                && ((exhibit.InventarNo != null && c.InventarNo == exhibit.InventarNo)
                                || (exhibit.DkNo != null && c.DkNo == exhibit.DkNo)
                                || (exhibit.IstehsalYeriId != null && c.IstehsalYeriId == exhibit.IstehsalYeriId)
                                || (exhibit.YazarId != null && c.YazarId == exhibit.YazarId)
        ...
        public ActionResult Create(ExhibitModel exhibit, DateTime? TehvilAlinmaTarixi, IFormFile[] files)
        {
            ...
            exhibit.Format = Format.XariciEdebiyyat;
            ...
            catch (Exception e)
            {
                ...
                return Redirect("~/XariciEdebiyyat/Create" +
        ...
        public ActionResult Edit(ExhibitModel exhibit, IFormCollection formCollection, IFormFile[] files, DateTime? tehvilAlinmaTarixi)
        {
            ...
            if (exhibit.InventarNo == null)
            {
                ...
                return Redirect("~/XariciEdebiyyat/Edit/" + exhibit.Id + "?hata=" + WebUtility.UrlEncode(hata));
            }
